...
return [
    ...
    'shop' => [
        'customer' => [
            ...
            'gdpr' => [
                'create-success' => 'GDPR-Anfrage wurde erfolgreich erstellt.',
                'revoke-success' => 'GDPR-Anfrage wurde erfolgreich widerrufen.',
                'revoke-failed'  => 'GDPR-Anfrage kann nicht widerrufen werden.',
            ],
        ],

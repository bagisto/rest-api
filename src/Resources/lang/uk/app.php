...
return [
    'admin' => [
        ...
        'customers' => [
            ...
            'addresses' => [
                ...
                'default-delete'  => 'Неможливо змінити адресу за замовчуванням.',
                'default-success' => 'Успішно позначено як адресу за замовчуванням.',
            ...
            'gdpr' => [
                'delete-success' => 'Запит GDPR було успішно видалено.',
                'update-success' => 'Запит GDPR було успішно оновлено.',
            ],
        ],
    ...
    'shop' => [
        'customer' => [
            ...
            'gdpr' => [
                'create-success' => 'Запит GDPR успішно створено.',
                'revoke-success' => 'Запит GDPR успішно відкликано.',
                'revoke-failed'  => 'Не вдалося відкликати запит GDPR.',
            ],
        ],

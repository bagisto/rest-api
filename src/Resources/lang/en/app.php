...
return [
    ...
    'common-response' => [
        'setting-roles' => [
            'add'    => 'roles added successfully.',
            'cancel' => 'roles canceled successfully.',
            'create' => 'roles created successfully.',
            'delete' => 'roles deleted successfully.',
            'update' => 'roles updated successfully.',
            'upload' => 'roles uploaded successfully.',

            'mass-operations' => [
                'delete'  => 'Selected roles successfully deleted.',
                'partial' => 'Some actions were not performed due to restricted system constraints on roles.',
                'update'  => 'Selected roles successfully updated.',
            ],
        ],
        ...
        'error' => [
            ...
            'being-used'                   => 'This resource roles is getting used.',
            ...
            'mass-operations' => [
                'resource-not-found' => 'Selected roles not found.',
            ],
        ],
        ...
        'error' => [
            ...
            'base-currency-delete'         => 'This currency is set as channel base currency so it can not be deleted.',
            'being-used'                   => 'This resource :name is getting used.',

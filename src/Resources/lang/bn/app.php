...
return [
    'admin' => [
        ...
        'customers' => [
            ...
            'addresses' => [
                ...
                'default-success' => 'সফলভাবে আপনার ডিফল্ট ঠিকানা হিসাবে নির্ধারণ করা হয়েছে।',
            ...
            'gdpr' => [
                'delete-success' => 'GDPR অনুরোধ সফলভাবে মুছে ফেলা হয়েছে।',
                'update-success' => 'GDPR অনুরোধ সফলভাবে আপডেট করা হয়েছে।',
            ],
        ],
    ...
    'shop' => [
        'customer' => [
            ...
            'gdpr' => [
                'create-success' => 'GDPR অনুরোধ সফলভাবে তৈরি হয়েছে।',
                'revoke-success' => 'GDPR অনুরোধ সফলভাবে বাতিল হয়েছে।',
                'revoke-failed'  => 'GDPR অনুরোধ বাতিল করা সম্ভব নয়।',
            ],
        ],

...
class InvoiceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'formatted_sub_total_incl_tax'            => core()->formatPrice($this->sub_total_incl_tax, $this->order_currency_code),
            ...
            'formatted_shipping_amount_incl_tax'      => core()->formatPrice($this->shipping_amount_incl_tax, $this->order_currency_code),
